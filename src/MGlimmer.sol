...
/**
 * @title Moonwell's MGlmr Contract
 * @notice MToken which wraps Glimmer
 * @author Moonwell
 */
contract MGlimmer is MToken {
    /**
     * @notice Construct a new MGlimmer money market
    ...
    function liquidateBorrow(address borrower, MToken mTokenCollateral) external payable {
        (uint256 err,) = liquidateBorrowInternal(borrower, msg.value, mTokenCollateral);
    ...
    /**
     * @notice Send Glimmer to MGlimmer to mint
     */
    ...
    /**
     * @notice Gets balance of this contract in terms of Glimmer, before this message
     * @dev This excludes the value of the current message, if any
     * @return The quantity of Glimmer owned by this contract
     */
     ...
     * @param from Address sending the Glimmer
     * @param amount Amount of Glimmer being sent
     * @return The actual amount of Glimmer transferred
     */
